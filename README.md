...
<h2> Samsara (Codex)</h2>
<img src="Portfolio5.png" alt="Samsara">
<p>As part of Infinity27’s UE5 Skills Bootcamp, I contributed to the UX for their souls-like Samsara by adding a comprehensive ‘Codex’ containing valuable info on gameplay, character abilities and exploration to the game’s pause menu. I worked to design, develop and test this feature for over four weeks. The goal was for it to act as a training tool for new players and as a helpful tool for expert players who would want to strategise and master game mechanics. I worked using sprint methods, which meant iterating on my previous work, week after week, and working alongside other developers when I needed to modify code, understand existing frameworks, or gather feedback from playtesters. Engine Used: Unreal Engine 5. </p>
